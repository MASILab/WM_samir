...
# There are a lot of small things to check or do: for each dataset we may want to remove outliers that are maybe 3 standard deviations outside normal. 
# Showing the dots with transparency would allow us to appreciate the density of dots. 
# We may also want to color data points base on dataset they came from (although that isn’t a requirement). 
